...
namespace MaoriSouvenirShopping.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LastName,FirstName,PhoneNumber,Email,Address")] Customer customer)
        {
            try
            {
       ...
       customerToUpdate,
       "",
       c => c.FirstName, c => c.LastName, c => c.PhoneNumber,
       c => c.Email, c => c.Address))
            {
                try
                {
                    await _context.SaveChangesAsync();
